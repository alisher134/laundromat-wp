document.addEventListener('DOMContentLoaded', () => {
  ...
  function renderShareButtons() {
    ...
    // Generate HTML with valid links
    shareWrapper.innerHTML = `
      <a href="https://t.me/share/url?url=${url}&text=${title}" target="_blank" class="${btnData}">
        ${tgIcon}
      </a>
      <a href="https://www.facebook.com/sharer/sharer.php?u=${url}" target="_blank" class="${btnData}">
        ${fbIcon}
      </a>
      <a href="https://vk.com/share.php?url=${url}&title=${title}" target="_blank" class="${btnData}">
        ${vkIcon}
      </a>
      <a href="#" id="copy-link-btn" class="${btnData}">
        ${copyIcon}
      </a>
    `;
